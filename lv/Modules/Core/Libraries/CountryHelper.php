...
class CountryHelper
{
    ...
    //---------------------------------------------------
    public static function getDetailsByCountryCode($country_code)
    {
        $countries = CountryHelper::getList();

        $country = CountryHelper::searchInMultidimensionalArray($countries, 'country_code', $country_code);

        return $country;
    }
    //---------------------------------------------------
    public static function getDetailsByCountryName($country_name)
    {
        $countries = CountryHelper::getList();

        $country = CountryHelper::searchInMultidimensionalArray($countries, 'name', $country_name);

        return $country;
    }
    //---------------------------------------------------
    public static function getDetailsByCountryCallingCode($calling_code)
    {
        $countries = CountryHelper::getList();

        $country = CountryHelper::searchInMultidimensionalArray($countries, 'calling_code', $calling_code);
